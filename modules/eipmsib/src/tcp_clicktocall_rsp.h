...
int tcp_clicktocall_start_rsp_encode_ipcmsg( tcp_clicktocall_start_rsp_t *clicktocall_rsp, tcp_msg_t *msg);

int tcp_clicktocall_start_rsp_init( tcp_clicktocall_start_rsp_t *clicktocall_rsp);
void tcp_clicktocall_start_rsp_final( tcp_clicktocall_start_rsp_t *clicktocall_rsp);
