...
/**
 * @brief �ش� ���� originator call_id ������ ��ȯ�Ѵ�.
...
/**
 * @brief clicktocall session�� originator call id ���� �����Ѵ�. 
 * @param dlgsess dlg session
...
/**
 * @brief �ش� ���� terminator call_id ������ ��ȯ�Ѵ�.
 * @param dlgsess dlg session
 * @return �߽��� call_id ����
 */
...
/**
 * @brief clicktocall session�� terminator call id ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param call_id ������ call_id 
 * @return ���� ���
 */
...
/**
 * @brief clicktocall session�� ms call id ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param call_id ������ call_id 
 * @return ���� ���
 */
...
/**
 * @brief �ش� ���� originator From header ������ ��ȯ�Ѵ�.
 * @param dlgsess dlg session
 * @return �߽��� from ����
 */
...
/**
 * @brief clicktocall session�� originator From header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ �߽� from
 * @return ���� ���
 */
...
/**
 * @brief �ش� ���� terminator From header ������ ��ȯ�Ѵ�.
 * @param dlgsess dlg session
 * @return �߽��� from ����
 */
...
/**
 * @brief clicktocall session�� terminator From header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ �߽� from
 * @return ���� ���
 */
...
/**
 * @brief clicktocall session�� ms From header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ �߽� from
 * @return ���� ���
 */
...
/**
 * @brief �ش� ���� originator To header ������ ��ȯ�Ѵ�.
 * @param dlgsess dlg session
 * @return �߽��� to ����
 */
...
/**
 * @brief clicktocall session�� originator To header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ �߽� to
 * @return ���� ���
 */
...
/**
 * @brief �ش� ���� terminator To header ������ ��ȯ�Ѵ�.
 * @param dlgsess dlg session
 * @return �߽��� to ����
 */
...
/**
 * @brief clicktocall session�� terminator To header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ �߽� to
 * @return ���� ���
 */
...
/**
 * @brief clicktocall session�� ms To header ���� �����Ѵ�. 
 * @param dlgsess dlg session
 * @param value ȣ ms to
 * @return ���� ���
 */
...
/**
 * @internal CLICKTOCALL dialog DAO�� �ʱ�ȭ�Ѵ�.
...
/**
 * @internal calling proceeding ���¿��� session�� update �Ѵ�.
 * @param dao DAO
...
/**
 * @internal called proceeding ���¿��� session�� update �Ѵ�.
 * @param dao DAO
 * @param dlgsess dialog session
 */
...
/**
 * @internal ms proceeding ���¿��� session�� update �Ѵ�.
 * @param dao DAO
 * @param dlgsess dialog session
 */
...
/**
 * @internal calling established ���¿��� session�� update �Ѵ�.
 * @param dao DAO
 * @param dlgsess dialog session
 */
...
/**
 * @internal called established ���¿��� session�� update �Ѵ�.
 * @param dao DAO
 * @param dlgsess dialog session
 */
...
/**
 * @internal ms established ���¿��� session�� update �Ѵ�.
 * @param dao DAO
 * @param dlgsess dialog session
 */
