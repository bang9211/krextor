#include "local/sswsim_conf_l.h"
#include <uxcutor/uxc_util.h>
#include <string.h>

/////////////////////////////////////////////////////////////////////////////////////////
// function to handle sswsim_conf_t
/////////////////////////////////////////////////////////////////////////////////////////
...
{
	return sswsim_conf_load( conf, cfile);
}
...
/*
	ux_log(UXL_INFO, "    DEFAULT_PRIVACY : %s", sswsim_util_privacy_to_str(conf->dflt_privacy));
